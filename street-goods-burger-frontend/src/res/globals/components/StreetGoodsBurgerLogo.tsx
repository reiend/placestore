...
interface StoreGoodsBurgerProps {
  className?: string;
  onClick?: () => void;
}

const StreetGoodsBurgerLogo = (props: StoreGoodsBurgerProps) => {
  return (
    <div>
      <svg
        {...props}
...
StreetGoodsBurgerLogo.propTypes = {
  className: PropTypes.string,
};

export default StreetGoodsBurgerLogo;
